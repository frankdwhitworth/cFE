...
designated test target:
    ...
    CFE_APP, blinker_app,    BLINKER_APP_Main,     BLINKER_APP,    50,   16384,  0x0,  0;
...
that blinker_app is included in the startup script by default because the cFE functional
